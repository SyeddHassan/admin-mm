...
>(({ className, ...props }, ref) => (
  ...
  >
    ...
    <IoClose className="-translate-x-1 text-white" />
    <IoCheckmarkSharp className="absolute translate-x-1 text-white" />
  </SwitchPrimitives.Root>
));
